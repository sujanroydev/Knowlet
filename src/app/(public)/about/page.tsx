...
export default function AboutPage() {
  const schema = {
    ...
    name: "About Knowlet",
    description:
      "Learn more about Knowlet, a free educational platform providing study materials and learning resources for college students.",
    url: `https://knowlet.in/about`,
    isPartOf: {
      "@type": "WebSite",
      name: "Knowlet",
      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <header className="border-b border-border pb-6 mb-8">
          <div className="max-w-4xl mx-auto px-5 pt-10">
            <h1 className="text-3xl md:text-4xl font-bold">About Knowlet</h1>
        ...
        <main className="max-w-4xl mx-auto px-5 py-14 space-y-8">
          ...
          <section className="bg-card rounded-2xl shadow-md border border-border p-6 md:p-8">
            ...
            <p className="leading-relaxed text-foreground">
              ...
              primarily for students. It provides a structured place to
              discover, organize, read, download, and work with academic
              resources such as notes, previous-year questions, important
          ...
          <section className="bg-card rounded-2xl shadow-md border border-border p-6 md:p-8">
            ...
            <p className="leading-relaxed text-foreground">
              Knowlet aims to make academic resources easier to discover,
              access, download, and understand. Instead of forcing students to
              search through scattered files, messages, websites, and folders,
              Knowlet organizes learning resources into a structured academic
              system.
            </p>
            ...
            <ul className="mt-4 list-disc pl-5 space-y-2 text-foreground">
              ...
              <li>
                ...
                clear structure instead of becoming a collection of random
                files.
              </li>
            </ul>
          </section>
          ...
          <section className="bg-card rounded-2xl shadow-md border border-border p-6 md:p-8">
            ...
            <ul className="list-disc pl-5 space-y-2 text-foreground">
              ...
              <li>
                Read learning content through a focused reading experience.
              </li>
              <li>
