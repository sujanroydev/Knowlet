      ...
      <div className="max-w-4xl mx-auto px-5 py-10">
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700 leading-relaxed">
            ...
            provide study materials, educational resources, learning tools,
            and other services that may support students and learners.
            Knowlet is not a replacement for teachers, educational
            institutions, professional advice, or official academic sources.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700 leading-relaxed">
            The information and resources available through Knowlet are
            provided primarily for educational and informational purposes.
            Educational requirements, syllabi, examination rules, and other
            academic information may change over time. Users should verify
            important information against official or authoritative sources
            when necessary.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700 leading-relaxed">
            ...
            completely accurate, current, complete, or free from errors.
            Knowlet should not be treated as the sole source of information for
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700 leading-relaxed">
            Certain Knowlet features may use artificial intelligence to
            generate explanations, summaries, questions, study assistance,
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700 leading-relaxed">
            Knowlet must not be used for unlawful, harmful, abusive,
            fraudulent, disruptive, or unauthorized activities. Users must
            also respect the intellectual property, privacy, and other rights
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700 leading-relaxed">
            Knowlet may collect and process information necessary to provide
            and maintain its services. The collection and use of personal
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700 leading-relaxed">
            ...
            property laws. Users should not reproduce, distribute, modify, or
            commercially exploit protected Knowlet materials without
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700 leading-relaxed">
            Knowlet provides its services and resources in good faith and to
