      ...
      <div className="max-w-4xl mx-auto px-5 py-10">
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-5 space-y-1 text-slate-700">
            ...
            <li>Do not upload harmful, abusive, illegal, or malicious content.</li>
            ...
            <li>Do not scrape, copy, or misuse platform data without permission.</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-5 space-y-1 text-slate-700">
            ...
            <li>Do not share your account in a way that compromises its security.</li>
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700">
            You retain ownership of content you create or upload to Knowlet.
            By using the service, you grant Knowlet the limited permission
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700">
            ...
            learning purposes. We do not guarantee that all content is
            complete, accurate, current, or suitable for every academic
            requirement. You are responsible for verifying information before
            relying on it for academic or other important decisions.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700">
            ...
            privacy policies. We are not responsible for services that we do
            not control.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700">
            ...
            services, or availability may change, be suspended, or be removed
            at any time.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700">
            ...
            We do not guarantee that the service or its content will always be
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-700">
            To the extent permitted by applicable law, Knowlet and its
            operators will not be responsible for indirect, incidental,
            consequential, or other losses arising from your use of or
